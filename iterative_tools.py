...
search_tool = TavilySearch(max_results=3, tavily_api_key="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")
...
#writer
writer_llm = ChatMistralAI(model_name="open-mistral-7b", mistral_api_key="YuP119ES8CSi1jX5pnIoBASVEl1FSEiE", temperature=0.7)

writer_llm_with_tools = writer_llm.bind_tools(tools)

#reviewer

reviewer_llm = ChatGroq(model="llama-3.3-70b-versatile",groq_api_key="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", temperature=0.2)
